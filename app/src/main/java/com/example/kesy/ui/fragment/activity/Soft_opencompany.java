 ...
 *创建者：LLR
 *日期：2019/12/25
 */public class Soft_opencompany extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.comprehensive_software_opencompany);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        StatusBarUtil.StatusBarLightMode(this);
        WebView webView = (WebView)findViewById(R.id.openbag_view);
        webView.loadUrl("https://www.oschina.net/company");
